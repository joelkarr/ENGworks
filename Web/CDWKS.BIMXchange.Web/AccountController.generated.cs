...
namespace CDWKS.BIMXchange.Web.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: CDWKS.BIMXchange.Web.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult LogOn(CDWKS.BIMXchange.Web.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOn);
        ...
        public override System.Web.Mvc.ActionResult Register(CDWKS.Model.EF.BIMXchange.User model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
