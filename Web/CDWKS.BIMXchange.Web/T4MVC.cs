...
public static class MVC {
    public static CDWKS.BIMXchange.Web.Controllers.AccountController Account = new CDWKS.BIMXchange.Web.Controllers.T4MVC_AccountController();
    public static CDWKS.BIMXchange.Web.Controllers.Base.BaseController Base = new CDWKS.BIMXchange.Web.Controllers.Base.T4MVC_BaseController();
    public static CDWKS.BIMXchange.Web.Controllers.DataController Data = new CDWKS.BIMXchange.Web.Controllers.T4MVC_DataController();
    public static CDWKS.BIMXchange.Web.Controllers.HomeController Home = new CDWKS.BIMXchange.Web.Controllers.T4MVC_HomeController();
...
namespace Links {
    ...
    public static class Content {
        ...
        public static class Images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string BIMXchange_logo_png = Url("BIMXchange-logo.png");
            public static readonly string btnAddFilter_png = Url("btnAddFilter.png");
            public static readonly string btnChangeLibrary_png = Url("btnChangeLibrary.png");
            public static readonly string btnFilterPage_png = Url("btnFilterPage.png");
            public static readonly string btnRemoveAll_png = Url("btnRemoveAll.png");
            public static readonly string btnTreePage_png = Url("btnTreePage.png");
            public static readonly string ByCadworksLogo_png = Url("ByCadworksLogo.png");
            public static readonly string HelpButton_png = Url("HelpButton.png");
            public static readonly string LoadFileButton_png = Url("LoadFileButton.png");
            public static readonly string LoginButton_png = Url("LoginButton.png");
            public static readonly string RegisterButton_png = Url("RegisterButton.png");
            public static readonly string remove_png = Url("remove.png");
            public static readonly string Sub_header_png = Url("Sub-header.png");
            public static readonly string TreeTab_png = Url("TreeTab.png");
            public static readonly string TypeCatalogButton_png = Url("TypeCatalogButton.png");
        ...
        public static class Scripts {
            ...
            public static readonly string jquery_hotkeys_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.hotkeys.min.js") ? Url("jquery.hotkeys.min.js") : Url("jquery.hotkeys.js");
                          
            public static readonly string jquery_jstree_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.min.jstree.min.js") ? Url("jquery.min.jstree.min.js") : Url("jquery.jstree.js");
        ...
        public static class Styles {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string contentstyle_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/contentstyle.min.css") ? Url("contentstyle.min.css") : Url("contentstyle.css");
                 
            public static readonly string jQuery_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jQuery.min.css") ? Url("jQuery.min.css") : Url("jQuery.css");
        ...
        public static class Theme {
            ...
            public static class apple {
                private const string URLPATH = "~/Content/Theme/apple";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string bg_jpg = Url("bg.jpg");
                public static readonly string d_png = Url("d.png");
                public static readonly string dot_for_ie_gif = Url("dot_for_ie.gif");
            ...
            public static class classic {
                private const string URLPATH = "~/Content/Theme/classic";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string d_gif = Url("d.gif");
                public static readonly string d_png = Url("d.png");
                public static readonly string dot_for_ie_gif = Url("dot_for_ie.gif");
                public static readonly string style_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/style.min.css") ? Url("style.min.css") : Url("style.css");
            ...
            public static class @default {
                private const string URLPATH = "~/Content/Theme/default";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string d_gif = Url("d.gif");
                public static readonly string d_png = Url("d.png");
