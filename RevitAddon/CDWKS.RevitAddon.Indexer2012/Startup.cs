...
namespace CDWKS.RevitAddon.Indexer2012
{
    ...
    public class Startup : IExternalApplication
    {
        ...
        {
            var rootPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\\Autodesk\\Revit\\Addins\\2012\\BIMXchangeAdmin.bundle";
            ...
            var pushButtonDataIndexer = new PushButtonData("Content Indexer", "Content Indexer", string.Format("{0}\\{1}", rootPath, str),
                                                     "CDWKS.RevitAddon.Indexer2012.IndexerCommand");
            ...
            var pushButtonDataTreeCreator = new PushButtonData("Library Tree", "Library Tree", string.Format("{0}\\{1}", rootPath, str),
                                                     "CDWKS.RevitAddon.Indexer2012.TreeViewCreator");
