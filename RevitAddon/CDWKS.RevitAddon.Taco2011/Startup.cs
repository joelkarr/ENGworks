...
namespace CDWKS.RevitAddon.Taco2011
{
    ...
    public class Startup : IExternalApplication
    {
        ...
        {
             var rootPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\\Autodesk\\Revit\\Addins\\2011\\BIMXchangeTaco.bundle";

            var panel = application.CreateRibbonPanel("Taco");

            var pdata = new PushButtonData("Taco Pump Finder", "Taco Pump Finder",
                                           string.Format("{0}\\CDWKS.RevitAddon.Taco2011.dll", rootPath), "CDWKS.RevitAddon.Taco2011.Command");
