...
namespace CDWKS.RevitAddon.BXC2012
{
    ...
    public class Startup : IExternalApplication
    {
        ...
        {
            var rootPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\\Autodesk\\Revit\\Addins\\2012\\BIMXchange.bundle";
            ...
            var pdata = new PushButtonData("BIMXchange v4.0", "BIMXchange v4.0",
                                           rootPath + @"\CDWKS.RevitAddon.BXC2012.dll", "CDWKS.RevitAddon.BXC2012.Command");
